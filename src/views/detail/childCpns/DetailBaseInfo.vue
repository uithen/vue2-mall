<template>
  <div class="base-info" v-if="Object.keys(goodsInfo).length!==0">
    ...
    <div class="info-price">
      ...
      <span class="discount" :style="{backgroundColor:goodsInfo.discountBgColor}" v-if="goodsInfo.discountDesc">
    ...
    <div class="info-service">
      <span class="info-service-item" v-for="index in goodsInfo.services.length" :key="index">
